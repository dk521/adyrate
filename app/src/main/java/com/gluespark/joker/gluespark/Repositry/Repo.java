...
public class Repo {
    ...
    public static Repo getInstance(Context context) {
        ...
        if (INSTANCE == null) {
            INSTANCE = new Repo(context.getApplicationContext());
        }
        return INSTANCE;
    }

    private Repo(Context applicationContext) {
...
//            int counter=0;
//            SingleShopModel localModel=null;
...
//                    Log.d("BASE",shopName);
//                     localModel=new SingleShopModel(shopId, shopAddress, shopImage,
